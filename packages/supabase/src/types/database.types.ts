  ...
  public: {
    Tables: {
      ...
      pregnancy_evolutions: {
        Row: {
          ...
          fetal_presentation: Database["public"]["Enums"]["fetal_presentation"] | null;
      ...
      team_invites: {
        Row: {
          ...
          patient_id: string;
          professional_type: Database["public"]["Enums"]["professional_type"] | null;
          status: string;
        };
        Insert: {
          created_at?: string | null;
    ...
    Enums: {
      ...
      notification_type:
        ...
        | "ultrasound_added"
        | "vaccine_updated";
      payment_method: "credito" | "debito" | "pix" | "boleto" | "dinheiro" | "outro";
      ...
      vaccine_name: "covid" | "influenza" | "hepatitis_b" | "dtpa" | "abrysvo" | "rhogam";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
