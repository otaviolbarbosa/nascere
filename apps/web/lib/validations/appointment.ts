...
const appointmentStatuses = ["agendada", "realizada", "cancelada"] as const satisfies readonly AppointmentStatus[]
...
export const updateAppointmentSchema = z.object({
  ...
  time: z.string().regex(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, "Horário inválido").optional(),
  duration: z.number().min(15, "Duração mínima de 15 minutos").optional(),
